...
const CTA = () => {
    return (
        ...
        className={`w-full h-full flex flex-col items-center 
            ...
            <div className='w-full h-full gap-5 px-4 py-20 flex flex-col items-center justify-center rounded-3xl border border-white/15 bg-linear-to-br from-[#09203F]/10 to-[#537895]/20 backdrop-blur-3xl shadow-lg shadow-gray-950 hover:border-[#d4af37] transition-all duration-300 ease-in-out'>
                <h1 className='text-white text-3xl lg:text-6xl max-sm:text-center font-bold'>Turn your Goals into <span className='text-[#d4af37]'>Grades</span></h1>

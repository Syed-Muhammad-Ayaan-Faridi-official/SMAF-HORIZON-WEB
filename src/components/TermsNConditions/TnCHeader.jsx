...
const TnCHeader = () => {
    return (
        <div className='flex flex-col gap-3 bg-linear-to-br from-[#09203F]/10 to-[#537895]/20 backdrop-blur-3xl border border-white/20 rounded-4xl px-2 py-6 md:px-13 md:py-8 justify-center max-md:items-center shadow-lg hover:shadow-[#d4af37]/50 transition-all duration-400 ease-in-out'>
            <h1 className='text-white capitalize  font-bold text-4xl md:text-5xl'>{TnC.title}</h1>
            ...
            <div id='btns' className='flex max-[500px]:flex-col gap-2 items-center'>
                <NavLink to={"/"}>
                    <button className='border bg-linear-to-r from-[#FFF3B0] via-[#D4AF37] to-[#8C6A00] border-[#D4AF37]/60  rounded-2xl px-6 py-3 font-semibold text-gray-800 hover:border-[#d4af37] shadow-lg hover:shadow-white/20 transition-all duration-300 ease-in'>Back to Home</button>
                </NavLink>
            </div>
        </div>
    )
